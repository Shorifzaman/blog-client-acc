            ...
            <div className="w-full shadow p-1 bg-white sticky top-0">
                <div className="xl:flex justify-between">
                        ...
                        <div className='flex-auto space-x-3 space-y-2 lg:space-y-0 font-normal text-sm'>
                            {
                                [
                                    ...
                                    { tag: "Git and Github", name: "Git and Github" },
                                    { tag: "Resume", name: "Resume" },
                                ].map((object, i) => <button
                                    key={i}
                    ...
                    <div className='lg:flex items-center m-2'>
                        ...
                        <select onChange={(e) => dispatch(toggleSort(e.target.value))} className="px-4 py-2 font-medium rounded-md bg-emerald-100 border-transparent focus:border-emerald-500 focus:bg-white focus:ring-0 text-emerald-800">
